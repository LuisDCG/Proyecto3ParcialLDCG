...
public class MeseroActivity extends AppCompatActivity {
    ...
    private void actualizarEstadoPedido(int idPedido) {
        String url = "http://192.168.131.89:8080/androidPHPSQL/actualizarEstadoPedido.php";
    ...
    private void aceptarPedido(int idPedido, String nombreMesero) {
        String url = "http://192.168.131.89:8080/androidPHPSQL/aceptarPedido.php";
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
    ...
    private void cargarPedidos() {
        String url = "http://192.168.131.89:8080/androidPHPSQL/listapedidos.php";
